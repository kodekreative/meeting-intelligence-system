...
export interface MeetingRecord {
  id: string
  fields: {
    'Meeting Date': string // ISO date string
    ...
    'Speaker Blocks': string // Read.ai speaker-attributed transcript
    'Topics': string[] // Array of topics discussed
    'Key Questions': string[] // Important questions raised
    'Report URL': string // Link to Read.ai report
    'Processing Status': 'pending' | 'processing' | 'complete' | 'failed'
    'Processed At': string // ISO timestamp
    'Created': string // Auto-generated by Airtable
    'Last Modified': string // Auto-generated by Airtable
  }
}
